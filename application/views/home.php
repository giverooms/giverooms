    ...
    <div id="search-container-wrap" class="row">
        ...
        <div id="search-container" class="col-xs-12 col-sm-10 col-md-10 col-lg-10" >
            ...
            <div id="search-by-region" class="row">
                    ...
                    <a href="<?php echo base_url(); ?>region/hotel/yangon">Yangon</a>
                    <a href="<?php echo base_url(); ?>region/hotel/mandalay">Mandalay</a>
                    <a href="<?php echo base_url(); ?>region/hotel/naypyitaw">Nay Pyi Taw</a>
                    <a href="<?php echo base_url(); ?>region/hotel/bago">Bagan</a>
                    <a href="<?php echo base_url(); ?>region/hotel/pyinoolwin">Pyin Oo Lwin</a>
                    <a href="<?php echo base_url(); ?>region/hotel/ngapali">Ngapali</a>
                    <a href="<?php echo base_url(); ?>region/hotel/ngwesaung">Ngwe Saung</a>
                    <a href="<?php echo base_url(); ?>region/hotel/chaungthar">Chaung Thar</a>
                    <a href="<?php echo base_url(); ?>region/hotel/kyaikhteyoe">Kyaik Hte Yoe</a>
                    <a href="<?php echo base_url(); ?>region/hotel/taunggyi">Taung Gyi</a>
            </div>
        </div>
            ...
            <div class="col-sm-12" id="body-info-holder">
                <div class="col-sm-5" id="body-info-btns">
                    <ul id="panel">
                        ...
                        ?>
                        <li class="animation">
                            <a href="<?php echo base_url(); ?>region/hotel/<?php echo $row['ct_name_en'];?>">
